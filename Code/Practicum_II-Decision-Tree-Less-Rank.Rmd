...
## Remove Rank columns
```{r BasketballRemoveRank}
Basketball <- subset(Basketball, select = -c(SCORING_OFFENSE_RANK))
Basketball <- subset(Basketball, select = -c(SCORING_DEFENCE_RANK))
Basketball <- subset(Basketball, select = -c(SCORING_MARGIN_RANK))
Basketball <- subset(Basketball, select = -c(REBOUND_MARGIN_RANK))
Basketball <- subset(Basketball, select = -c(ASSISTS_PER_GAME_RANK))
Basketball <- subset(Basketball, select = -c(BLOCKED_SHOTS_PER_GAME_RANK))
Basketball <- subset(Basketball, select = -c(STEALS_PER_GAME_RANK))
Basketball <- subset(Basketball, select = -c(TURNOVER_MARGIN_RANK))
Basketball <- subset(Basketball, select = -c(ASSIST_TURNOVER_RATIO_RANK))
Basketball <- subset(Basketball, select = -c(FIELD_GOAL_PER_RANK))
Basketball <- subset(Basketball, select = -c(FIELD_GOAL_PER_DEFENSE_RANK))
Basketball <- subset(Basketball, select = -c(THREE_PT_FIELD_GOALS_PER_RANK))
Basketball <- subset(Basketball, select = -c(THREE_PT_FIELD_GOAL_PER_RANK))
Basketball <- subset(Basketball, select = -c(FREE_THROW_PER_RANK))
Basketball <- subset(Basketball, select = -c(WON_LOST_PER_RANK))
Basketball <- subset(Basketball, select = -c(OPP_SCORING_OFFENSE_RANK))
Basketball <- subset(Basketball, select = -c(OPP_SCORING_DEFENCE_RANK))
Basketball <- subset(Basketball, select = -c(OPP_SCORING_MARGIN_RANK))
Basketball <- subset(Basketball, select = -c(OPP_REBOUND_MARGIN_RANK))
Basketball <- subset(Basketball, select = -c(OPP_ASSISTS_PER_GAME_RANK))
Basketball <- subset(Basketball, select = -c(OPP_BLOCKED_SHOTS_PER_GAME_RANK))
Basketball <- subset(Basketball, select = -c(OPP_STEALS_PER_GAME_RANK))
Basketball <- subset(Basketball, select = -c(OPP_TURNOVER_MARGIN_RANK))
Basketball <- subset(Basketball, select = -c(OPP_ASSIST_TURNOVER_RATIO_RANK))
Basketball <- subset(Basketball, select = -c(OPP_FIELD_GOAL_PER_RANK))
Basketball <- subset(Basketball, select = -c(OPP_FIELD_GOAL_PER_DEFENSE_RANK))
Basketball <- subset(Basketball, select = -c(OPP_THREE_PT_FIELD_GOALS_PER_RANK))
Basketball <- subset(Basketball, select = -c(OPP_THREE_PT_FIELD_GOAL_PER_RANK))
Basketball <- subset(Basketball, select = -c(OPP_FREE_THROW_PER_RANK))
Basketball <- subset(Basketball, select = -c(OPP_WON_LOST_PER_RANK))
```
