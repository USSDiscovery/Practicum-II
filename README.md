...
2. Data Cleaning - Python - Oracle
3. Exploratory Data Analysis - Python - Oracle - Tableau
4. Model Building (Decision Tree, Random Forest, K Nearest Neighbors, Support Vector Machines, Artificial Neural Networks) - R
5. Model Analysis - R
6. Summary
